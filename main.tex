...
also due to floating particles in the water. These interactions increase
...
pipelines, from the camera to the marker detector. The algorithms ran on a 
Linux Mint 18 Cinnamon 64-bit machine, Intel Core i7-3540M CPU @ 3.00GHz x 2,
memory RAM of 15.6 Gb and a NVIDIA GF108GLM (NVS 5200M) graphics card.
...
\subsection{Pre-processing methods analysis}
...
\begin{figure}[!ht]
    ...
    \caption{Relation between detected frames, pre-processing method and image size.}
